...
from src.datasets.euroc import EuRoCSemanticDataset
def get_dataset(config_dict, basedir, sequence, **kwargs):
    if config_dict["dataset_name"].lower() in ["replica"]:
        ...
        return ScannetSemanticDataset(config_dict, basedir, sequence, **kwargs)
        ...
        return EuRoCSemanticDataset(config_dict, basedir, sequence, **kwargs)
    else:
